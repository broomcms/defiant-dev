...
class WP_Block_Parser_Block {
	...
	/**
	 * defiantnt HTML from inside block comment delimiters
	 ...
	 * @param string $innerHTML    defiantnt HTML from inside block comment delimiters after removing inner blocks.
